...
import AuditplanEditForm from './AuditplanEditForm';
...
const re = RegExp('^(?:[0-9]|0[1-9])$');
 class AuditplanEdit extends React.Component {
  ...
  constructor() {
    ...
    this.auditplanEdit = this.auditplanEdit.bind(this);
    ...
    this.status = ['Select','planned','scheduled','ongoing','closed'];
 ...
 handleRisk(){
  ...
  render() {
    const { isEdited, errors } = this.props.auditPlan;
         ...
         <div className='bwm-form'>
            <div className='row'>
              ...
              <div className = "card-body">
                  ...
                  */}
                  <AuditplanEditForm submitCb={this.auditplanEdit}
                     options={this.auditYears}
                     options1 ={this.auditMonths}
                     options2 ={this.status}
                     errors={errors}
...
export default connect(mapStateToProps)(AuditplanEdit)  
